...
N_GENERATION = 30           # training step
LR = 0.05                    # learning rate
SIGMA = 0.55                 # mutation strength or step size
N_CORE = mp.cpu_count()-3   # 1 main process,7 sub process
...
def CA_Configuration(net_param):
    ...
    VarMin = -100                     # Lower Bound of Weights and Biases
    VarMax = 100                        # Upper Bound of Weights and Biases
